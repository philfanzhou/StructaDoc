    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                parse_run_id = table.Column<Guid>(type: "TEXT", nullable: false),
                type = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                unit = table.Column<string>(type: "TEXT", unicode: false, maxLength: 32, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                type = table.Column<string>(type: "TEXT", unicode: false, maxLength: 64, nullable: false),
                subtype = table.Column<string>(type: "TEXT", unicode: false, maxLength: 100, nullable: true),
                content = table.Column<string>(type: "TEXT", nullable: true),
                content_format = table.Column<string>(type: "TEXT", unicode: false, maxLength: 32, nullable: true),
                bbox_x0 = table.Column<double>(type: "REAL", nullable: true),
                bbox_y0 = table.Column<double>(type: "REAL", nullable: true),
                bbox_x1 = table.Column<double>(type: "REAL", nullable: true),
                bbox_y1 = table.Column<double>(type: "REAL", nullable: true),
