        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    target_type = table.Column<string>(type: "TEXT", unicode: false, maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    principal_issuer = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    principal_subject = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    permissions = table.Column<int>(type: "INTEGER", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                    created_at_utc = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
