    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                default_marker = table.Column<string>(type: "TEXT", unicode: false, maxLength: 16, nullable: true),
                current_version_id = table.Column<Guid>(type: "TEXT", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                base_url = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                model = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                backend = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                protected_credential = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                created_at_utc = table.Column<DateTime>(type: "TEXT", nullable: false)
            },
            constraints: table =>
            {
